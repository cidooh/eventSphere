...
function Ticketattendee(){
    ...
    return(
        <div className="mt-24 container mx-auto w-[700px] shadow-xl mb-10">
...
<div className="border-2 bg-slate-300 p-10 text-xl ">
    <p className="text-2xl p-3">Event Title:</p>
    <p className="p-3 text-2xl">Standard Ticket: Ticket #1</p>
...
<div>
    <Link to="/attendee"><button className="bg-slate-900 text-white text-xl hover:scale-110 shadow-2xl p-5 w-full rounded-2xl">Checkout</button></Link>
</div>
